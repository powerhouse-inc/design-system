    ...
    return useMemo(() => {
        switch (tableName) {
                        ...
                        ? [
                              {
                                  ...
                                  Input: () => (
                                      <>
                                          {handleTableDatum(tableItem.notional)}
                                      </>
                                  ),
                              },
                              {
                                ...
                                <RWATableTextInput
                                    {...register('CUSIP', {
                                        ...
                                        pattern: {
                                            value: /^[a-zA-Z0-9]*$/,
                                            message:
                                                'CUSIP must be alphanumeric',
                                        },
                                    })}
                                    aria-invalid={
                                        errors.CUSIP ? 'true' : 'false'
                                    }
                                ...
                                <RWATableTextInput
                                    {...register('ISIN', {
                                        ...
                                        pattern: {
                                            value: /^[a-zA-Z0-9]*$/,
                                            message:
                                                'ISIN must be alphanumeric',
                                        },
                                    })}
                                    aria-invalid={
                                        errors.ISIN ? 'true' : 'false'
                                    }
            ...
            case tableNames.TRANSACTION: {
                ...
                const serviceProviderFeeTypeOptions =
                        ...
                        ? {
                              ...
                              Input: () => (
                                  <RWANumberInput
                                      ...
                                      disabled={operation === 'view'}
                                      errorMessage={
                                          errors.fixedIncomeAmount?.message
                                      }
                        ...
                        Input: () => (
                            <RWATableTextInput
                                {...register('name', {
                                    disabled: operation === 'view',
                                    required:
                                        'Fixed Income Type name is required',
                                })}
                                aria-invalid={
                                    errors.name?.type === 'required'
                                        ? 'true'
