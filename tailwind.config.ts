...
const config = {
    ...
    theme: {
        ...
        colors: {
            ...
            'red-500': 'hsl(var(--color-red-600) / <alpha-value>)',
            'red-400': 'hsl(var(--color-red-600) / <alpha-value>)',
            'red-300': 'hsl(var(--color-red-600) / <alpha-value>)',
            'red-200': 'hsl(var(--color-red-600) / <alpha-value>)',
            'red-100': 'hsl(var(--color-red-600) / <alpha-value>)',
        },
        extend: {
            keyframes: {
                'fade-in': {
